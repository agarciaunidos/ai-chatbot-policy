...
from aws_secrets_initialization import PINECONE_API_KEY, COHERE_API_KEY, INDEX_NAME, embeddings, llm
...
knowledge_base_tool = Tool(
    ...
    description='Use this tool to answer questions about UnidosUS or NCLR, providing more information about the topic.'
)
